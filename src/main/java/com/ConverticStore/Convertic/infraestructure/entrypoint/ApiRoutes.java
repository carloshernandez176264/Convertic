package com.ConverticStore.Convertic.infraestructure.entrypoint;

import com.ConverticStore.Convertic.infraestructure.entrypoint.user.UserHandler;
...
//                .andRoute(GET(pathBase).and(accept(MediaType.APPLICATION_JSON)), handler::queryUsers)
                ...
                .andRoute(DELETE(pathBase.concat(param)).and(accept(MediaType.APPLICATION_JSON)), handler::deleteUser);
    }
